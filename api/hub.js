// AgentDeck verify + admin + download in one module (Vercel serverless)
// Routes:
...
const PEPPER = process.env.ACCESS_PEPPER || 'agentdeck-pepper-5m2k9t';

const FILES = [
  '01-agentdeck-system.pdf', '02-job-scorecard.pdf', '03-grounding-pack.pdf', '04-prompt-contract.pdf', '05-trigger-map.pdf', '06-guardrails.pdf', '07-receipt-tracker.pdf', '08-agentdeck-playbook.pdf',
];
